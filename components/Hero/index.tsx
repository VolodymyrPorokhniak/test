          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              ...
              >
                ...
                Kharkiv Regional Capture The Flag
                </h1>
                <p className="mb-12 text-base text-justify font-medium !leading-relaxed text-body-color dark:text-white dark:opacity-90 sm:text-lg md:text-xl">
                  Шановні учасники!<br/>
                  Вітаємо Вас на Kharkiv Regional CTF!<br/>
                  Цей захід організовано за підтримки Проєкту USAID «Кібербезпека критично важливої інфраструктури України».<br/>
                  Метою змагання є отримання практичного досвіду з кібербезпеки.<br/>
                  Тож бажаємо Вам успіхів та креативних рішень!<br/>

                  З повагою,<br/>
                  Організатори Kharkiv Regional CTF<br/>
                </p>
